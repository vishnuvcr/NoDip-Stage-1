...
def test_four_leg_pnl_and_next_session_entry():
    ...
    # Expiry sequence: E0, E1, E2, E3, E4.
    dates = [
        "2024-01-04", "2024-01-11", "2024-01-18", "2024-01-25",
        "2024-02-01", "2024-02-08",
    ]
    exps = ["2024-01-04", "2024-01-11", "2024-01-18", "2024-01-25", "2024-02-01"]
    for d in dates:
        for e in exps:
    ...
    # Entry after E0 is 2024-01-05.
    # Make entry prices and E1 / E4 exit prices unique for auditable P&L.
    for r in rows:
    ...
    spot = pd.DataFrame({
        "date": pd.to_datetime(["2024-01-04", "2024-01-05", "2024-01-11"]),
