...
| P3 Engine/tests | COMPLETE | Frozen engine implemented; CI import/setup defects corrected; public C/P parser regression test added; manual backtest workflow kept manual-only to avoid duplicate runs |
